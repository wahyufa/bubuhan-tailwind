          ...
          <div className="mx-auto max-w-7xl py-6 px-8 sm:px-6 lg:flex  lg:justify-between lg:py-2 lg:px-16">
            <div className="left-content flex-auto px-0 lg:px-2">
              <div class="py-4 px-2 lg:p-6   rounded-lg shadow-md hover:dark:bg-gray-800/20 hover:ring-1 hover:ring-slate-800">
                <span className="bg-gray-400 text-gray-800 text-xs inline-flex items-center px-2.5 py-1 rounded mr-2 dark:bg-gray-900 dark:text-gray-500">
                  <svg
                    aria-hidden="true"
                ...
                <a href="#">
                  <p className="pt-4 text-base mb-2 font-semibold tracking-tight text-gray-900 dark:text-white">
                ...
                <a
                  href="#"
                  className="inline-flex items-center text-emerald-600 pt-4"
                >
                  Read more
                  <svg
                    viewBox="0 0 16 16"
              ...
              <div className="py-4 px-2 lg:p-6 rounded-lg shadow-md hover:dark:bg-gray-800/20 hover:ring-1 hover:ring-slate-800">
                <span className="bg-gray-400 text-gray-800 text-xs inline-flex items-center px-2.5 py-1 rounded mr-2 dark:bg-gray-900 dark:text-gray-500">
                  <svg
                    aria-hidden="true"
                    className="mr-1 w-3 h-3"
            ...
            <div className="right-content pt-12  w-max lg:w-96 lg:pr-8 lg:pt-0 ">
              <div className="max-w-md  p-4  rounded-lg shadow-md sm:p-8 ring-1 ring-slate-800">
                <div className="flex items-center justify-between mb-4 ">
                  <h5 className="text-xl flex-1 font-bold leading-none text-gray-900 dark:text-white">
                    Categories
                  </h5>
                  <a
                    href="#"
                  ...
                  <form>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="search"
                        id="search"
                        className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-black dark:border-gray-800 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-800 dark:focus:border-emerald-800"
                        placeholder="Email Address"
                        required
                      />
                      <button
                        type="submit"
                        className="text-white absolute right-2.5 bottom-2.5 bg-emerald-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-emerald-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      >
                        Submit
                      </button>
                    </div>
